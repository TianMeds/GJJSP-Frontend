        ...
        <MUI.FormControl sx={{ minWidth: 120, mr: 2 }}>
          ...
          <MUI.TableContainer>
            <MUI.Table> 
              <MUI.TableHead>
                <MUI.TableRow>
                <MUI.TableCell sx={{fontWeight: 'bold', fontSize: '0.8rem'}}>Category</MUI.TableCell>
                ...
                <MUI.TableBody>
                  {partners
                    ...
                    <MUI.TableRow key={index} className='partner' sx={{backgroundColor: index % 2 === 0 ? '#fbf3f2' : '#e0e0e0'}}>
                      <MUI.TableCell sx={{ borderBottom: '1px solid rgba(224, 224, 224, 1)', borderRight: '1px solid rgba(224, 224, 224, 1)', fontStyle: 'italic' }}  className='partnerName'>{partner.category}</MUI.TableCell>
          ...
          <MUI.Dialog open={partner} onClose={handleClosePartner} fullWidth maxWidth="xs" component='form' onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <MUI.DialogContent>
              ...
              <MUI.Grid id="partnerSchoolGrid">
                <MUI.InputLabel htmlFor="category" id="partnerSchoolLabel">Category</MUI.InputLabel>
                <Controller
                  name="category"
                  control={control}
                  defaultValue={null}
                  ...
                  render={({ field }) =>  (
                    <MUI.FormControl sx={{  width: '100%', borderRadius: '8px' }}>
                      ...
                      >
                        ...
                        <option value="Religous Congregation">Religious Congregation</option>
                ...
                />
                {errors.category && (
                  <p id='errMsg'> <MUI.InfoIcon className='infoErr'/>{errors.category?.message}</p>
                )}
              </MUI.Grid>
